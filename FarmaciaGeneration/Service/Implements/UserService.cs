    ...
    public class UserService : IUserService
    {
        ...
        public async Task<User?> Create(User usuario)
        {
            ...
            if (usuario.Foto is null || usuario.Foto == "")
                usuario.Foto = "https://img.freepik.com/vetores-premium/design-de-personagem-fofo-menino-masculino-medico-trabalhador-medico-farmacia-medica-hospital-design-vetorial-isolado_773815-110.jpg";
